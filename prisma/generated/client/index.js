...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Abdul Rehman\\Documents\\GitHub\\ecommerce-next\\prisma\\generated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Abdul Rehman\\Documents\\GitHub\\ecommerce-next\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgres://neondb_owner:npg_bUqQKhW9z7Xx@ep-plain-scene-a561yhzg-pooler.us-east-2.aws.neon.tech/neondb?sslmode=require"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Product {\n  id          String   @id @default(dbgenerated(\"gen_random_uuid()\")) @db.Uuid\n  name        String\n  slug        String   @unique(map: \"product_slug_idx\")\n  category    String\n  images      String[]\n  brand       String\n  description String\n  stock       Int\n  price       Decimal  @default(0) @db.Decimal(12, 2)\n  rating      Decimal  @default(0) @db.Decimal(3, 2)\n  numReviews  Int      @default(0)\n  isFeatured  Boolean  @default(false)\n  banner      String?\n  sizes       String[]\n  colors      String[]\n  createdAt   DateTime @default(now()) @db.Timestamp(6)\n  updatedAt   DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "ea4cb173b0fcafea8edc9db8e5045b6f8c6192761032896b5eea5ec29aea47a0",
  "copyEngine": true
}
